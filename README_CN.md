...
它将你的笔记作为纯文本 `.md` 文件保存在本地的设备上——没有任何**数字围栏**，你可以使用任何你喜欢的方式（如 Syncthing, Nextcloud 等）进行同步。
...
> **关于开发的说明**：本项目几乎完全由 **Google Antigravity** 构建。由于 Lomo 是根据我的特定需求定制的，只要它还是我日常工具链的一部分，我就会一直维护它。如果你对 AI 生成代码的稳定性有顾虑，欢迎 Fork 并根据你的需求进行修改。
